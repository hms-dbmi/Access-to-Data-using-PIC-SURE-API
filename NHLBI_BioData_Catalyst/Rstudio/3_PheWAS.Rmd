...
```{r}
### SEVEN BRIDGES USERS ONLY: RESTART YOUR KERNEL BEFORE RUNNING THIS CODE
#install.packages(c('stringr', 'ggplot2', 'ggrepel'))
#library(rlang)
#library(dplyr)
#library(stringr)
#library(ggplot2)
...
install.packages(c('dplyr', 'stringr', 'ggplot2', 'ggrepel'))
library(dplyr)
library(stringr)
library(ggplot2)
library(ggrepel)
...
We will also select our cohorts of interest. In this example, we are interested in participants from the Framingham Heart Study (FHS) and the Atherosclerosis Risk In Communities (ARIC) cohort. We can utilize the `\\DCC Harmonized data set\\demographic\\subcohort_1\\` concept path in the DCC Harmonized data set to select the participants of interest.
